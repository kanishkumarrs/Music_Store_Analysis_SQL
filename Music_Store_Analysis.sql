/* Senior most employees based on job title */
...
/* City with the best customers. We would like to throw a promotional Music Festival in the city we made the most money. 
...
/* The best customer. The customer who has spent the most money will be declared the best customer. 
...
/* Amount of money spent by each customer on artists. A query to return customer name, artist name and total money spent */

/* First, we find which artist has earned the most according to the Invoice Lines. Now we use this artist to find 
which customer spent the most on this artist. For this query, we will need to use the Invoice, Invoice Line, Track, Customer, 
Album, and Artist tables. Note, the Total spent in the Invoice table might not be on a single product, 
...
with the highest amount of purchases. A query that returns each country along with the top Genre. */
